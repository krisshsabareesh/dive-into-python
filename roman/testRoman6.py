...
class ToRomanBadInput(unittest.TestCase) :                               
  ...
  def test_non_integer(self) :
    ...
    self.assertRaises(roman6.NotAnIntegerError, roman6.to_roman, 0.5)
...
class FromRomanBadInput(unittest.TestCase) :
  def test_too_many_repeated_numerals(self) :
    '''from_roman should fail with too many repeated numerals, too many depends on the numeral'''
    for s in ('MMMM', 'DD', 'CCCC', 'LL', 'XXXX', 'VV', 'IIII') :
      self.assertRaises(roman6.InvalidRomanNumeralError, roman.from_roman, s)
  def test_repeated_pairs(self) :
    '''from_roman should fail for repeated pair of numerals'''
